...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', lessonType: LessonType, title: string, slug: string, id: string, availableAt?: any | null }> };
